...
export const useProfileCurrencyValue = () =>
  useRecoilValue(profileCurrencyState)
...
export const useProfileCurrencySymbolValue = () =>
  useRecoilValue(profileCurrencySymbolState)
